...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">SISARPRAS</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item @if(\Request::is($user->role . '/dashboard')) active @endif">
        ...
        <li class="menu-item @if(\Request::is($user->role . '/profile')) active @endif">
            <a href="{{ route('profile.'. $user->role) }}" class="menu-link">
        ...
        <li class="menu-item @if(\Request::is($user->role . '/admin')) active @endif">
            <a href="{{ route('admin') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-briefcase"></i>
                <div data-i18n="Item">Data Admin</div>
            </a>
        </li>

        <li class="menu-item @if(\Request::is($user->role . '/location')) active @endif">
            <a href="{{ route('location') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-buildings"></i>
                <div data-i18n="Item">Data Lokasi</div>
            </a>
        </li>
        @endif
        ...
        <li class="menu-item @if(\Request::is($user->role . '/item')) active @endif">
            <a href="{{ route('item.'. $user->role) }}" class="menu-link">
                ...
                <div data-i18n="Item">Data Barang</div>
            </a>
        </li>

        <li class="menu-item @if(\Request::is($user->role . '/borrow')) active @endif">
            <a href="{{ route('borrow.'. $user->role) }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-sort-alt-2"></i>
                <div data-i18n="Borrow">Pinjam Barang</div>
            </a>
        </li>

        <li class="menu-item @if(\Request::is($user->role . '/history')) active @endif">
            <a href="{{ route('history.'. $user->role) }}" class="menu-link">
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-3">
                        <h5 class="text" style="text-align: center;">Kamu yakin ingin logout?</h5>
                    </div>
                </div>
            </div>
